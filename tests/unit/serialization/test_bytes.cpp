...
TEST(Serialize_Bytes, EndianHelpers)
{
    ...
    EXPECT_EQ(bswap32(0x11223344u), 0x44332211u);
    ...
    EXPECT_EQ(be16toh(htobe16(v16)), v16);
    EXPECT_EQ(be32toh(htobe32(v32)), v32);
    EXPECT_EQ(be64toh(htobe64(v64)), v64);
}
