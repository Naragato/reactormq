...
{
    const std::vector topicFilters = { TopicFilter("topic1", QualityOfService::AtMostOnce),
...
{
    const std::vector topicFilters = { TopicFilter("home/temp", QualityOfService::AtMostOnce),
...
TEST(Subscribe5, Constructor_WithSubscriptionOptions)
{
    const std::vector topicFilters = { TopicFilter(
        "test/topic", QualityOfService::AtLeastOnce, true, false, RetainHandlingOptions::DontSendRetainedMessagesAtSubscribeTime) };
...
{
    const std::vector topicFilters = { TopicFilter(
        "test", QualityOfService::ExactlyOnce, true, true,
...
{
    std::vector topicFilters = { TopicFilter(
        "test/topic", QualityOfService::AtLeastOnce, false, true, RetainHandlingOptions::SendRetainedMessagesAtSubscribeTime) };
