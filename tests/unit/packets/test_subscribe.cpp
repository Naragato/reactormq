...
TEST(Subscribe3, Constructor_SingleTopicFilter)
{
    const std::vector topicFilters = {
        TopicFilter("test/topic", QualityOfService::AtMostOnce)
    };
...
{
    const std::vector topicFilters = {
        TopicFilter("topic1", QualityOfService::AtMostOnce),
        TopicFilter("topic2", QualityOfService::AtLeastOnce),
        TopicFilter("topic3", QualityOfService::ExactlyOnce)
    };
...
{
    const std::vector topicFilters = {
        TopicFilter("test", QualityOfService::AtMostOnce)
    };
...
{
    const std::vector topicFilters = {
        TopicFilter("a", QualityOfService::AtMostOnce),
        TopicFilter("bc", QualityOfService::AtLeastOnce)
    };
    const Subscribe3 packet(topicFilters, 1);
...
{
    const std::vector topicFilters = {
        TopicFilter("test", QualityOfService::AtLeastOnce)
    };
...
{
    const std::vector topicFilters = {
        TopicFilter("test", QualityOfService::ExactlyOnce)
    };
    const Subscribe3 packet(topicFilters, 42);
...
{
    const std::vector topicFilters = {
        TopicFilter("test/topic", QualityOfService::AtLeastOnce)
    };
...
{
    const std::vector topicFilters = {
        TopicFilter("home/temp", QualityOfService::AtMostOnce),
        TopicFilter("home/humid", QualityOfService::AtLeastOnce)
    };
...
TEST(Subscribe5, Constructor_WithProperties)
{
    ...
    const Subscribe5 packet(topicFilters, 42, props);
...
TEST(Subscribe5, RoundTrip_SingleTopic)
{
    std::vector topicFilters = {
        TopicFilter(
            "test/topic", QualityOfService::AtLeastOnce, false, true,
