...
{
    ConnectReturnCode codes[] = {
        ConnectReturnCode::Accepted,
        ConnectReturnCode::RefusedProtocolVersion,
        ConnectReturnCode::RefusedIdentifierRejected,
        ConnectReturnCode::RefusedServerUnavailable,
...
TEST(ConnAck5, Constructor_WithProperties)
{
    ...
    const ConnAck5 packet(false, ReasonCode::Success, props);
...
TEST(ConnAck5, IsReasonCodeValid_ValidCodes)
{
    ...
    {
        EXPECT_TRUE(ConnAck5::isReasonCodeValid(code))
            << "Code " << static_cast<int>(code) << " should be valid";
    }
}
...
TEST(ConnAck5, IsReasonCodeValid_InvalidCodes)
{
    ...
    {
        EXPECT_FALSE(ConnAck5::isReasonCodeValid(code))
            << "Code " << static_cast<int>(code) << " should be invalid";
    }
}
...
TEST(ConnAck5Properties, EncodeDecode_UserProperty)
{
    ...
    const ConnAck5 packet(true, ReasonCode::Banned, props);
