...
{
    const std::vector reasonCodes = { ReasonCode::Success, ReasonCode::NoSubscriptionExisted, ReasonCode::NotAuthorized };
...
TEST(UnsubAck5, Constructor_WithProperties)
{
    ...
    const UnsubAck5 packet(42, reasonCodes, props);
...
TEST(UnsubAck5, GetLength_Varies)
{
    ...
    const std::vector codes2 = { ReasonCode::Success, ReasonCode::NoSubscriptionExisted, ReasonCode::NotAuthorized };
