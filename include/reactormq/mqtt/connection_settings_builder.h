...
namespace reactormq::mqtt
{
     ...
     *
     * Responsibilities:
     * - Allow selective configuration of connection parameters with sensible defaults.
     * - Provide fluent API for ergonomic construction.
     * - Build immutable ConnectionSettings instances.
     * 
     * Notes:
    ...
    public:
        /**
         * @brief Construct a builder with required parameters.
         ...
         * @param protocol The protocol (Mqtt, Mqtts, Ws, Wss).
         * @return Reference to this builder for chaining.
         */
         ...
         * @return Reference to this builder for chaining.
         */
        ConnectionSettingsBuilder& setCallbackExecutor(CallbackExecutor executor)
        {
            m_callbackExecutor = std::move(executor);
            return *this;
        }

        /**
         * @brief Build the ConnectionSettings instance.
         * @return Shared pointer to the constructed ConnectionSettings.
         */
