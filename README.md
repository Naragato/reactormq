...
Treat the UE5 folder as a module you can add to your project.  
Add it as a dependency in your `.Build.cs`.  
Plugin packaging will arrive later to simplify integration.

### O3DE (Gem)

Enable the Gem in your project and point the engine to its path.  
More detailed instructions will land once the API settles.
