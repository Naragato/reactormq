...
{
    /**
     * @brief Socket state for the O3DE socket adapter.
     */
    ...
    /**
     * @brief O3DE socket adapter for ReactorMQ.
     * 
     * Supports both plain TCP (mqtt://) and TLS (mqtts://) connections using O3DE's TcpSocket and TlsSocket.
