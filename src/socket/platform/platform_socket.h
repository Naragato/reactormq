...
namespace reactormq::socket
{
    ...
    public:
        ...
        [[nodiscard]] virtual size_t getPendingData() const;
         ...
         */
        virtual bool tryReceive(uint8_t* outData, int32_t bufferSize, size_t& bytesRead) const;
         ...
         * @return True if the call completed (including zero bytes read); false on error or closed connection.
         */
        virtual bool tryReceiveWithFlags(uint8_t* outData, int32_t bufferSize, ReceiveFlags flags, size_t& bytesRead) const;
