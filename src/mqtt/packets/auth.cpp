...
namespace reactormq::mqtt::packets
{
    ...
    bool Auth::decode(serialize::ByteReader& reader)
    {
        ...
        if (m_fixedHeader.getPacketType() != PacketType::Auth)
        {
            REACTORMQ_LOG(
                ...
                "[Auth] Invalid packet type: expected Auth, got %d",
    ...
    bool Auth::isReasonCodeValid(const ReasonCode reasonCode)
    {
        ...
        case ReasonCode::ContinueAuthentication:
        case ReasonCode::ReAuthenticate:
            return true;
        default:
            return false;
        }
    ...
    bool Auth::arePropertiesValid(const properties::Properties& properties)
    {
        for (const auto props = properties.getProperties(); const auto& prop : props)
        {
            ...
            default:
                REACTORMQ_LOG(
                    logging::LogLevel::Error,
                    "[Auth] Invalid property identifier: %u",
