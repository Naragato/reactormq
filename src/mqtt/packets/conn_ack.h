...
namespace reactormq::mqtt::packets
{
    ...
    public:
        ...
        explicit ConnAckBase(const FixedHeader& fixedHeader)
            : TControlPacket(fixedHeader), m_bSessionPresent(false)
        {
        }
    ...
    protected:
        static constexpr std::byte kSessionPresentBit{std::byte{0x1}};
    ...
    public:
        ...
        explicit ConnAck(const bool bSessionPresent, const ConnectReturnCode returnCode)
            : ConnAckBase(bSessionPresent), m_returnCode(returnCode)
        {
        ...
        explicit ConnAck(serialize::ByteReader& reader, const FixedHeader& fixedHeader)
            : ConnAckBase(fixedHeader), m_returnCode(ConnectReturnCode::Accepted)
        {
    ...
    public:
        ...
        explicit ConnAck(
            ...
            : ConnAckBase(bSessionPresent), m_reasonCode(reasonCode), m_properties(std::move(properties))
        {
            m_fixedHeader = FixedHeader::create(this);
         ...
         */
        explicit ConnAck(serialize::ByteReader& reader, const FixedHeader& fixedHeader)
            : ConnAckBase(fixedHeader), m_reasonCode(ReasonCode::Success)
        {
            m_isValid = decode(reader);
        }
