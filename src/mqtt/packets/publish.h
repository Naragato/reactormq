...
namespace reactormq::mqtt::packets
{
    ...
    public:
        ...
        explicit PublishBase(
            ...
            : m_topicName(std::move(topicName)), m_packetIdentifier(packetIdentifier), m_payload(std::move(payload))
        {
        }
        ...
        {
            const auto flags = static_cast<std::byte>(m_fixedHeader.getFlags());
            return getQualityOfService() != QualityOfService::AtMostOnce
                   && (flags & kDupBit) == kDupBit;
        }
