...
{
    // MQTT 3.1.1
    void PubComp<ProtocolVersion::V311>::encode(serialize::ByteWriter& writer) const
    {
    ...
    bool PubComp<ProtocolVersion::V311>::decode(serialize::ByteReader& reader)
    {
    ...
    // MQTT 5
    void PubComp<ProtocolVersion::V5>::encode(serialize::ByteWriter& writer) const
    {
    ...
    bool PubComp<ProtocolVersion::V5>::decode(serialize::ByteReader& reader)
    {
