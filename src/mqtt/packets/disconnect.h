...
namespace reactormq::mqtt::packets
{
    ...
    public:
         ...
         */
        explicit DisconnectBase() = default;
    };
    ...
    public:
         ...
         */
        explicit Disconnect(
            const ReasonCode reasonCode = ReasonCode::NormalDisconnection,
            properties::Properties properties = properties::Properties{})
            : DisconnectBase(), m_reasonCode(reasonCode), m_properties(std::move(properties))
        {
            m_fixedHeader = FixedHeader::create(this);
         ...
         */
        explicit Disconnect(serialize::ByteReader& reader, const FixedHeader& fixedHeader)
            : DisconnectBase(fixedHeader), m_reasonCode(ReasonCode::Success)
        {
            m_isValid = decode(reader);
        }
