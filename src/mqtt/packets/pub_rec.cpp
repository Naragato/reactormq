...
{
    // MQTT 3.1.1
    void PubRec<ProtocolVersion::V311>::encode(serialize::ByteWriter& writer) const
    {
    ...
    bool PubRec<ProtocolVersion::V311>::decode(serialize::ByteReader& reader)
    {
    ...
    // MQTT 5
    void PubRec<ProtocolVersion::V5>::encode(serialize::ByteWriter& writer) const
    {
    ...
    bool PubRec<ProtocolVersion::V5>::decode(serialize::ByteReader& reader)
    {
