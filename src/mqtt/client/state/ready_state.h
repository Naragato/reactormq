...
namespace reactormq::mqtt::client
{
    ...
    private:
         ...
         * @return Optional state transition.
         */
        static StateTransition handleSubAck(Context& context, const packets::IControlPacket& packet, packets::ProtocolVersion protocolVersion);
         ...
         * @return Optional state transition.
         */
        static StateTransition handleUnsubAck(Context& context, const packets::IControlPacket& packet, packets::ProtocolVersion protocolVersion);

        /**
         * @brief Handle received PUBLISH packet.
         * @param context Shared context.
         * @param packet The received packet.
         * @param protocolVersion MQTT protocol version.
         * @return Optional state transition.
         */
        static StateTransition handlePublish(Context& context, const packets::IControlPacket& packet, packets::ProtocolVersion protocolVersion) ;
         ...
         * @return Optional state transition.
         */
        static StateTransition handlePubRec(const Context& context, const packets::IControlPacket& packet, packets::ProtocolVersion protocolVersion) ;
         ...
         * @return Optional state transition.
         */
        static StateTransition handlePubRel(Context& context, const packets::IControlPacket& packet, packets::ProtocolVersion protocolVersion) ;
