...
namespace reactormq::mqtt::client
{
    ...
    std::unique_ptr<packets::IControlPacket> parsePacketImpl(
        serialize::ByteReader& reader,
        const packets::FixedHeader& fixedHeader,
    ...
    decltype(auto) withMqttVersion(const packets::ProtocolVersion version, F&& f)
    {
        ...
        case packets::ProtocolVersion::V311: {
            return std::forward<F>(f)(
                std::integral_constant<packets::ProtocolVersion, packets::ProtocolVersion::V311>{});
        }
        case packets::ProtocolVersion::V5: {
            return std::forward<F>(f)(
                std::integral_constant<packets::ProtocolVersion, packets::ProtocolVersion::V5>{});
        }
        }
